    ...
    def fit(self, training_epoches = 20, batch_size = 128, display_step = 1):
        ...
        for epoch in range(training_epoches):
            ...
            if epoch % display_step == 0:
                self.save_result(file_name="{}-result-{}-{}-{}-{}".format(1, epoch, self.autoencoder.n_input,
                                                                          self.autoencoder.n_hidden, avg_cost))

                print("{} n_hidden = {} Epoch:{} cost={:.9f}".format(time.strftime("%H:%M:%S", time.localtime()),
                                                          self.autoencoder.n_hidden, epoch + 1, avg_cost))
...
if __name__ == '__main__':
    ...
    for n_hidden in n_hiddens:
        ...
        runner.fit(batch_size=256, display_step = 100, training_epoches=1000)
